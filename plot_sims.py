...
def plot_first_four_sources(fits_files, output_file):
    ...
    for i, fits_file in enumerate(fits_files[:4]):
        ...
        im1 = ax1.imshow(-1*spectral_index_map, origin='lower', cmap='inferno_r', interpolation='none', vmin=0.5, vmax=4) #gist_rainbow_r
        ...
        im2 = ax2.imshow(spectral_index_error_map, origin='lower', cmap='inferno', interpolation='none', norm=LogNorm()) #turbo
